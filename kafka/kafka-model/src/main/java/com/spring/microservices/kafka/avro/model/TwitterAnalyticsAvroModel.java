...
public class TwitterAnalyticsAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8011575411720132625L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TwitterAnalyticsAvroModel\",\"namespace\":\"com.spring.microservices.kafka.avro.model\",\"fields\":[{\"name\":\"word\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"wordCount\",\"type\":[\"null\",\"long\"]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public static com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder newBuilder() {
    return new com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder();
  }
   ...
   * @return A new TwitterAnalyticsAvroModel RecordBuilder
   */
  public static com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder newBuilder(com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder other) {
    if (other == null) {
      return new com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder();
    } else {
      return new com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder(other);
    }
  }
   ...
   * @return A new TwitterAnalyticsAvroModel RecordBuilder
   */
  public static com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder newBuilder(com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel other) {
    if (other == null) {
      return new com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder();
    } else {
      return new com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TwitterAnalyticsAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.word)) {
        this.word = data().deepCopy(fields()[0].schema(), other.word);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder setWord(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder clearWord() {
      word = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder setWordCount(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder clearWordCount() {
      wordCount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAnalyticsAvroModel.Builder clearCreatedAt() {
      createdAt = null;
