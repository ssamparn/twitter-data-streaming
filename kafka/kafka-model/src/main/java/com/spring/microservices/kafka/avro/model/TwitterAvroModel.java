 ...
 */
package com.spring.microservices.kafka.avro.model;
...
public class TwitterAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4128476994699115743L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TwitterAvroModel\",\"namespace\":\"com.spring.microservices.kafka.avro.model\",\"fields\":[{\"name\":\"userId\",\"type\":\"long\"},{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"text\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"createdAt\",\"type\":[\"null\",\"long\"],\"logicalType\":[\"null\",\"date\"]}]}");
   ...
   */
  public static com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder newBuilder() {
    return new com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder();
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder newBuilder(com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder other) {
    if (other == null) {
      return new com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder();
    } else {
      return new com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder(other);
    }
  }
   ...
   * @return A new TwitterAvroModel RecordBuilder
   */
  public static com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder newBuilder(com.spring.microservices.kafka.avro.model.TwitterAvroModel other) {
    if (other == null) {
      return new com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder();
    } else {
      return new com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TwitterAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.spring.microservices.kafka.avro.model.TwitterAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder setUserId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder setText(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder setCreatedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.microservices.kafka.avro.model.TwitterAvroModel.Builder clearCreatedAt() {
      createdAt = null;
